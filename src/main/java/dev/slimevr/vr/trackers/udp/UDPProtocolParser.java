...
public class UDPProtocolParser {
	...
	public void write(ByteBuffer buf, TrackerUDPConnection connection, UDPPacket packet)
		throws IOException {
	...
	public void writeHandshakeResponse(ByteBuffer buf, TrackerUDPConnection connection)
		throws IOException {
