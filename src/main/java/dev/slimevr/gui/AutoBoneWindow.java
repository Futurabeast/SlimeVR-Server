...
public class AutoBoneWindow extends JFrame implements AutoBoneListener {
	...
	public void onAutoBoneEpoch(Epoch epoch) {
		processLabel.setText(String.format("PROCESS: Epoch %d/%d (%.2f%%) Error: %.4f", epoch.epoch, epoch.totalEpochs, (epoch.epoch / (double)epoch.totalEpochs) * 100.0, epoch.epochError));
